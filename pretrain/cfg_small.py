...
config = {
    ...
    'log_interval': 1,                             # Logging interval for debugging (None, int)
...
#        'collate_fn': lambda x: x,                 # collate_fn to get minibatch as list instead of tensor
    ...
    'loss': {
        'latent_loss_coef': 0.1,                    # coefficient of latent loss (beta) in VAE during SL training
    ...
    'rl':{
        'num_processes': 2,                        # how many training CPU processes to use (default: 32)
        'num_steps': 2,                             # 'number of forward steps (default: 32)'
        'num_env_steps': 10e1,                      # 'number of environment steps to train (default: 10e6)'
        ...
        'loss':{
                ...
                'latent_rl_loss_coef': 0.1,             # coefficient of latent loss (beta) in VAE during RL training
    ...
    'num_lstm_cell_units': 2,                      # RNN latent space size
